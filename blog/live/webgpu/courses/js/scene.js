...
async function main() {
  ...
  const texture = await createTextureFromImages(
      device,
      [
        '../resources/images/skybox/christmas_photo_studio_01/360degree/px.png',  /* webgpufundamentals: url */
        '../resources/images/skybox/christmas_photo_studio_01/360degree/nx.png',  /* webgpufundamentals: url */
        '../resources/images/skybox/christmas_photo_studio_01/360degree/py.png',  /* webgpufundamentals: url */
        '../resources/images/skybox/christmas_photo_studio_01/360degree/ny.png',  /* webgpufundamentals: url */
        '../resources/images/skybox/christmas_photo_studio_01/360degree/pz.png',  /* webgpufundamentals: url */
        '../resources/images/skybox/christmas_photo_studio_01/360degree/nz.png',  /* webgpufundamentals: url */
      ],
  ...
  function render(time) {
    ...
    // cameraPositionValue.set([Math.cos(time * .3) * 10, 0, 0.5 * Math.max(0.5, Math.sin(time * .4)) * 10]);
    cameraPositionValue.set([Math.cos(time * .3) * 10, 0, 0.3 * Math.sin(time * .3) * 10]);
    // cameraPositionValue.set([Math.cos(time * .3) * 10 * Math.max(0.5, Math.sin(time * .2)), 0, Math.sin(time * .1) * 10]);
